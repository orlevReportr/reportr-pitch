...
export function MarketSection() {
  ...
  return (
    <section id="market" ref={sectionRef} className="py-20 bg-muted/30">
          ...
          {marketData.map((item, index) => (
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm font-medium text-accent mb-2">{item.growth}</div>
        ...
        <div className={`transition-all duration-1000 delay-500 ${isVisible ? "animate-fade-in" : "opacity-0"}`}>
          <Card className="bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4">Australia-First Strategy vs. Global Competitors</h3>
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <a 
                      ...
                      className="inline-flex items-center px-4 py-2 text-sm border border-accent/20 rounded-lg bg-accent/5 hover:bg-accent/10 transition-colors text-accent-foreground font-medium"
                    >
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
